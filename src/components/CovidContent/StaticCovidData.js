  ...
  const chart = () => {
    ...
    axios
      ...
      .then(res => {
        ...
        cov_last_ndeaths.push(
          parseInt(res.data[res.data.length - 1].new_deaths)
        ) //
        cov_last_nrec.push(
          parseInt(res.data[res.data.length - 1].new_recoveries)
        )
              ...
              <Col xs={12} sm={3}>
                ...
                >
                  ...
                  <Button
                    ...
                    size='sm'
                    className=''
                    onClick={e => download_chart(e, 'chart10')}
                  >
                    <FiDownload />
                  </Button>
                </motion.div>
