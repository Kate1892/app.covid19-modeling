...
export function Footer() {
  return (
    <footer className='py-4 my-6 bg-dark navbar-fixed-bottom row-fluid'>
      <Container>
        <Row
          style={{
            width: '100%',
        ...
        >
          <Col xs={12} md={12} lg={6}>
            <div className='mx-5'>
              ...
              <div className='text-white text-muted mx-auto'>
                630090, Новосибирск, Проспект академика Лаврентьева, 6,
                ком.2-431
              </div>
              <div className='text-white text-muted mx-auto'>
                контакты: info@covid19-modeling.ru, +7 (383) 330-84-60
              </div>

              <hr className='text-white mx-auto' />
              <small
                align='left'
                className='text-center text-muted text-white mx-auto'
              >
                © 2022 COVID-19 в Новосибирской области
              </small>
            </div>
          </Col>
