                  ...
                  <Table striped bordered size='sm' responsive>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          Параметр заражения между бессимптомной <i>E(t)</i> и
                          восприимчивой <i>S(t)</i> группами населения (
                          <i>
                            {'\u03B1'}
                            <sub>E</sub>>>{'\u03B1'}
                            <sub>I</sub>
                      ...
                      <tr>
                        ...
                        <td>
                          Доля госпитализированных случаев <i>H(t)</i>, которым
                          требуется подключение ИВЛ
                        </td>
                        <td>(0, 1)</td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td>
                          Средняя продолжительность гуморального иммунитета
                          после выздоровления
                        </td>
                        <td>180 дней</td>
                      </tr>
              ...
              <Card.Body align=''>
                ...
                <Stack direction='horizontal' gap={3}>
                  <div className=''>
                    {' '}
                    <div>
                      <i>{'\u03B2'}(t)</i> – доля инфицированных, имеющая
