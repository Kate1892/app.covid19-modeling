...
export function Modeling() {
  ...
  const [data_cov_cum_diag_high, setData_cov_cum_diag_high] =
    useState(cov_cum_diag_high)
  const [data_cov_cum_diag, setData_cov_cum_diag] = useState(cov_cum_diag)

  let cov_new_death = []
  let cov_new_death_high = []
  const [data_cov_new_death_high, setData_cov_new_death_high] =
    useState(cov_new_death_high)
  const [data_new_death, setData_cov_new_death] = useState(cov_new_death)

  let cov_new_rec = []
  let cov_new_rec_high = []
  const [data_cov_new_rec_high, setData_cov_new_rec_high] =
    useState(cov_new_rec_high)
  const [data_new_rec, setData_cov_new_rec] = useState(cov_new_rec)

  let cov_new_crit = []
  let cov_new_crit_high = []
  const [data_cov_new_crit_high, setData_cov_new_crit_high] =
    useState(cov_new_crit_high)
